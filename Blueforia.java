 ...
 */
@Autonomous(name="Blueforia", group="Pushbot")
public class Blueforia extends LinearOpMode
{
    DcMotor right;
    DcMotor left;
    DcMotor slide;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        right.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT); // delete
        left.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT); // delete
        forwards(2200, .4); // 2350
        sleep(500);
        right.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE); // delete
        right.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE); // delete
        turnleft(425, .4);
        sleep(500);
        ...
        right.setPower(0.1);
        left.setPower(0.1);
        while(opModeIsActive() && wheels.getPose().getTranslation().get(2) < -150)
        {
            ...
            else if(wheels.getPose().getTranslation().get(0) < -0)
            {
                slide.setPower(-0.25);
