...
@Autonomous(name="Red_102", group="Pushbot")

public class Red_102 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        colorr = hardwareMap.colorSensor.get("color l");

        colorr.setI2cAddress(I2cAddr.create7bit(0x36));
        ...
        while(hsvlinefront[2] < 0.1) // while front line following sensor does not see the tape
...

        {
            ...
            if (colorr.red() > colorr.blue()) // if left button is blue
            ...
            else if (colorr.red() < colorr.blue()) // if left button is red
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if(rangesensor.getDistance(DistanceUnit.CM) <= 16) // if  distance sensor is within 13cm of the wall
